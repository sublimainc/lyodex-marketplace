 ...
 *   STRIPE_SECRET_KEY=sk_test_... node scripts/register-stripe-webhook.mjs your-domain.replit.dev
 *
 * The script:
...
if (!domain) {
  console.error(
    "Error: cannot determine webhook domain.\n" +
      ...
      "  node scripts/register-stripe-webhook.mjs your-repl.replit.dev"
  );
  process.exit(1);
}
