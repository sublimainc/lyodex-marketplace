 ...
 *   PROD_DOMAIN=my-domain.com node scripts/verify-stripe-webhook.mjs
 *
...
if (!endpoint) {
  ...
  console.error("  Fix:  Run node scripts/register-stripe-webhook-prod.mjs");
  exitCode = 1;
} else {
  ...
  if (missingEvents.length > 0) {
    ...
    console.error("  Fix:  Run node scripts/register-stripe-webhook-prod.mjs to update the endpoint.");
    exitCode = 1;
  } else {
