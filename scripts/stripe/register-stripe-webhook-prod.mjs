 ...
 *   STRIPE_SECRET_KEY=sk_live_... node scripts/stripe/register-stripe-webhook-prod.mjs
 *
 * Usage (with a custom production domain override):
 *   PROD_DOMAIN=my-custom-domain.com node scripts/stripe/register-stripe-webhook-prod.mjs
 *
 * The script:
